...
?>
                    <section id="custom-field" class="typecho-post-option<?php if (empty($defaultFields) && empty($fields)): ?> fold<?php endif; ?>">
                        <label id="custom-field-expand" class="typecho-label"><a href="##"><i class="i-caret-right"></i> <?php _e('Custom Fields'); ?></a></label>
                        <table class="typecho-list-table mono">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <select name="fieldTypes[]" id="fieldtype">
                                        <option value="str"<?php if ('str' == $field['type']): ?> selected<?php endif; ?>><?php _e('Character'); ?></option>
                                        <option value="int"<?php if ('int' == $field['type']): ?> selected<?php endif; ?>><?php _e('Integer'); ?></option>
                                        <option value="float"<?php if ('float' == $field['type']): ?> selected<?php endif; ?>><?php _e('Decimal'); ?></option>
                                    </select>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td>
                                    <label for="fieldname" class="sr-only"><?php _e('Field Name'); ?></label>
                                    <input type="text" name="fieldNames[]" placeholder="<?php _e('Field Name'); ?>" id="fieldname" class="text-s w-100">
                                </td>
                                <td>
                                    <label for="fieldtype" class="sr-only"><?php _e('Field Type'); ?></label>
                                    <select name="fieldTypes[]" id="fieldtype">
                                ...
                                <td>
                                    <label for="fieldvalue" class="sr-only"><?php _e('Field Value'); ?></label>
                                    <textarea name="fieldValues[]" placeholder="<?php _e('Field Value'); ?>" id="fieldvalue" class="text-s w-100" rows="2"></textarea>
                                </td>
                                <td>
                                    <button type="button" class="btn btn-xs"><?php _e('Delete'); ?></button>
                                </td>
                        ...
                        <div class="description clearfix">
                            <button type="button" class="btn btn-xs operate-add"><?php _e('+ Add Field'); ?></button>
                            <?php _e('Custom fields can extend your templates, see usage <a href="http://docs.typecho.org/help/custom-fields">Help Documentation</a>'); ?>
                        </div>
                    </section>
