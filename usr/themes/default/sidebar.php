...
<div class="col-mb-12 col-offset-1 col-3 kit-hidden-tb" id="secondary" role="complementary">
    ...
    <section class="widget">
		<h3 class="widget-title"><?php _e('Latest Articles'); ?></h3>
	...
	<section class="widget">
        ...
        <ul class="widget-list">
            <?php if($this->user->hasLogin()): ?>
				<li class="last"><a href="<?php $this->options->adminUrl(); ?>"><?php _e('Into the background'); ?> (<?php $this->user->screenName(); ?>)</a></li>
            ...
            <?php endif; ?>
            <li><a href="<?php $this->options->feedUrl(); ?>"><?php _e('Articles RSS'); ?></a></li>
